...
\begin{frame}{Fuego frente a Incendio: Distinción Conceptual}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\textbf{Fuego (Proceso Dominado)}}
        \small
        $\bullet$ Reacción fisicoquímica de óxido-reducción fuertemente exotérmica.\\
        $\bullet$ Emisión controlada de luz, calor y humos.\\
      ...
      \resizebox{0.9\columnwidth}{!}{%
        \begin{tikzpicture}
          \node[draw=successgreen!80!black, fill=successgreen!10, rounded corners=4pt, line width=1.2pt, inner sep=6pt, text width=5cm, align=center] {
            ...
            \scriptsize Hornos $\cdot$ Calderas $\cdot$ Soldadura $\cdot$ Motores
          };
        \end{tikzpicture}
      }
    \end{column}
...
\begin{frame}{Regímenes de Combustión: Escala Física de Velocidad}
  \small
  ...
  \resizebox{0.95\textwidth}{!}{%
    \begin{tikzpicture}[xscale=1.2, line cap=round, line join=round]
      ...
      % Barrera del sonido
      \draw[dashed, line width=1pt, firered] (7.2, 1.8) -- (7.2, -0.8) node[below, font=\tiny\bfseries, firered] {Barrera del Sonido ($333\,\mathrm{m/s}$)};
...
\begin{frame}{Temperaturas Críticas de Inflamación de Sustancias}
  \begin{columns}[c]
    \begin{column}{0.52\textwidth}
      \begin{block}{\textbf{1. Inflamación (\textit{Flash Point})}}
      ...
      \end{block}
      \begin{block}{\textbf{2. Punto de Fuego (\textit{Fire Point})}}
...
\begin{frame}{Clasificación Normalizada de Fuegos (IRAM 3517 / NFPA 10)}
  ...
  \resizebox{0.98\textwidth}{!}{%
    \begin{tikzpicture}[xscale=2.2, line cap=round, line join=round]
      ...
      \node[below=8pt, font=\tiny, align=center] at (A) {\textbf{Sólidos Orgánicos}\\Madera, papel, telas\\Residuos con brasas};
      ...
      \node[below=8pt, font=\tiny, align=center] at (B) {\textbf{Líquidos y Gases}\\Naftas, solventes, aceites\\Combustión superficial};

      % Clase C
      \node[circle, draw=utnblue!90!black, fill=utnblue!20, line width=1.5pt, inner sep=4pt] (C) at (2.4,0) {\bfseries\large C};
      \node[below=8pt, font=\tiny, align=center] at (C) {\textbf{Equipos Eléctricos}\\Tableros energizados\\Riesgo de electrocución};
      ...
      \node[below=8pt, font=\tiny, align=center] at (D) {\textbf{Metales Reactivos}\\Magnesio, sodio, titanio\\Polvos especiales};
      ...
      \node[below=8pt, font=\tiny, align=center] at (K) {\textbf{Grasas y Aceites}\\Cocinas industriales\\Saponificación alcalina};
    \end{tikzpicture}
  }
\end{frame}
