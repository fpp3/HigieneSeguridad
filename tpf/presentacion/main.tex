...
\titlegraphic{\hfill\includegraphics[height=1.0cm]{images/UTN_logo.png}}

\begin{document}

\input{sections/0-portada_agenda.tex}
\input{sections/1-fundamentos_combustion.tex}
\input{sections/2-efectos_marco_legal.tex}
\input{sections/3-sistemas_deteccion_extincion.tex}
\input{sections/4-prevencion_casos_estudio.tex}
\input{sections/5-cierre.tex}
