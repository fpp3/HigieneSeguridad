...
\section{Extintores Portátiles (Matafuegos)}
...
diseño, selección, ensayo y mantenimiento se encuentran regulados en el país por las normas IRAM 3517 (Partes 1 y 2) y el
Decreto Reglamentario 351/79, con base conceptual en la norma NFPA 10.
...
\begin{itemize}
    \item Agua Presurizada y Agua Pulverizada: Recipientes construidos en chapa de acero inoxidable cargados con agua
          tratada y presurizados con nitrógeno seco. En su configuración de chorro pleno, actúan exclusivamente sobre fuegos
          Clase A mediante enfriamiento endotérmico. En su versión de agua desmineralizada con tobera pulverizadora especial,
          la fragmentación en microgotas y la ausencia de iones disueltos eliminan la conductividad eléctrica, permitiendo
          su uso seguro en recintos con tensión eléctrica moderada sin riesgo de electrocución ni corrosión por sales.
    \item Espuma Mecánica (AFFF y AR-AFFF): Solución acuosa con concentrados sintéticos fluorocarbonados que forman una
          película acuosa flotante. Apto para fuegos Clase A y Clase B. La película
          sella la superficie líquida de los hidrocarburos, bloqueando la emisión de vapores inflamables y enfriando el
          combustible. Para líquidos polares como solventes, acetonas y alcoholes, se requieren formulaciones resistentes a
          alcoholes (AR-AFFF), las cuales generan una barrera polimérica protectora que impide que el solvente destruya la
          espuma.
    \item Polvo Químico Seco (PQS) Triclase ABC: Compuesto en un $75\percent$ a $90\percent$ por fosfato monoamónico
          ...
          $180\Celsius$, originando ácido metafosfórico vítreo que tapona los poros y aísla el carbono del oxígeno; en
          líquidos inflamables (Clase B), el polvo captura radicales libres en la llama deteniendo la reacción en cadena; y
          por ser un polvo aislante, no conduce la electricidad (Clase C). No obstante, en instalaciones electrónicas
          presenta una desventaja crítica: es higroscópico y altamente corrosivo, por lo que su descarga en centros de datos
          o tableros electrónicos destruye pistas de cobre, componentes SMD y relés.
    \item Polvo Químico Seco BC: Formulado a base de bicarbonato de sodio ($\mathrm{NaHCO_3}$) o bicarbonato de potasio
          ...
          dejar una capa adherente vidriada, facilitando su limpieza mecánica en maquinarias pesadas.
    \item Dióxido de Carbono ($CO_2$): Gas comprimido a alta presión en cilindros de acero sin costura, encontrándose en
          ...
          liberado a través de una tobera difusora cónica, experimenta una expansión adiabática brusca (efecto
          Joule-Thomson), proyectando gas denso y partículas sólidas de nieve carbónica a $-78.5\Celsius$. Extingue por
          desplazamiento del oxígeno y enfriamiento superficial. Al ser un gas inerte, limpio y rigurosamente dieléctrico, no
          deja ningún residuo químico ni humedad, siendo el agente idóneo para tableros eléctricos, consolas de mando,
          bancos de pruebas y salas de servidores.
    \item Agentes Limpios Halocarbonados: Sustancias químicas fluoradas o clorofluoradas de última generación (como el
          HFC-236fa o la fluorocetona FK-5-1-12) en recipientes presurizados. Se descargan en forma de líquido vaporizante de
...
fuego normalizadas de laboratorio. Para la Clase A, los valores van de 1-A a 40-A (evaluados con entramados estandarizados
de madera de pino), donde un extintor 2-A extingue el doble de masa de madera que uno 1-A. Para la Clase B, el potencial
varía de 1-B a 120-B, representando el área de bateas de ensayo con líquidos inflamables. Para la Clase C, la letra se
...
Cuando las dimensiones del establecimiento o la concentración calórica superan la capacidad de extinción manual, la
seguridad edilicia requiere sistemas fijos automáticos o semiautomáticos.

\subsection{Redes de Hidrantes e Instalaciones de Agua contra Incendios (NFPA 14 e IRAM 3597)}

Las redes de hidrantes constituyen la columna vertebral hidráulica de la extinción industrial. La instalación consta de:
\begin{itemize}
...
\subsection{Sistemas de Rociadores Automáticos (Sprinklers - NFPA 13)}
...
\subsection{Sistemas de Agua Nebulizada (Water Mist - NFPA 750)}
...
\subsection{Sistemas de Inundación Total por Dióxido de Carbono (NFPA 12)}
...
\subsection{Sistemas de Supresión mediante Agentes Limpios Gaseosos (NFPA 2001)}
...
En la Tabla \ref{tab.cap6:sistemas_fijos} se resume el análisis comparativo de los sistemas fijos de extinción.

\begin{table}[!ht]
    \centering
    \resizebox{\textwidth}{!}{
    \begin{tabular}{|>{\raggedright\arraybackslash}p{3.8cm}|>{\raggedright\arraybackslash}p{3.2cm}|>{\raggedright\arraybackslash}p{3.5cm}|>{\raggedright\arraybackslash}p{3.2cm}|>{\raggedright\arraybackslash}p{4.2cm}|}
        \hline
        \textbf{Sistema Fijo} & \textbf{Agente Extintor} & \textbf{Mecanismo Principal} & \textbf{Aptitud Eléctrica} & \textbf{Riesgo Humano / Recinto} \\ \hline
        Red de Hidrantes (BIE) & Agua presurizada & Enfriamiento endotérmico. & Prohibido en tensión & Nulo (riesgo mecánico de chorro). \\ \hline
        Rociadores Húmedos & Agua & Enfriamiento & Incompatible en tensión & Daño residual severo por anegamiento. \\ \hline
        Acción Previa (Preaction) & Agua & Enfriamiento controlado & Condicionado a corte previo & Seguro ante disparos accidentales. \\ \hline
        Agua Nebulizada & Microgotas de agua & Enfriamiento y sofocación & Alta compatibilidad & Mínimo daño residual colateral. \\ \hline
        Inundación $CO_2$ & Dióxido de carbono & Sofocación por dilución & Totalmente dieléctrico & Letal por asfixia (requiere enclavamientos). \\ \hline
        Agentes Limpios (FK-5-1-12) & Fluorocetona sintética & Absorción calórica molecular & Excelente dieléctrico & Seguro para personas ($\le\text{NOAEL}$). \\ \hline
        Gases Inertes (IG-541) & $N_2 + Ar + CO_2$ & Reducción parcial de $O_2$ & Totalmente dieléctrico & Respirable en concentraciones de diseño. \\ \hline
    \end{tabular}
    }
    \caption{Comparativa técnica de sistemas fijos de extinción contra incendios.}
    \label{tab.cap6:sistemas_fijos}
\end{table}
