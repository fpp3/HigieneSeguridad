...
\begin{itemize}
    \item Límites de Inflamabilidad: Rango de concentraciones de vapor en aire dentro del cual la mezcla resulta
          combustible. Queda delimitado por el Límite Inferior de Inflamabilidad (LII), por debajo del cual la mezcla es
          demasiado pobre para arder, y el Límite Superior de Inflamabilidad (LSI), por encima del cual la mezcla es
          demasiado rica en combustible por defecto de oxígeno. Las elevaciones de temperatura ambiente provocan un
          ensanchamiento de dicho rango.
    \item Temperatura de Inflamación: Temperatura mínima a la cual un líquido o sólido combustible
          desprende vapores en cantidad suficiente para formar una mezcla inflamable que se enciende de manera instantánea
          al aproximar una fuente externa de ignición, sin sostener la llama al retirarla.
    \item Temperatura de Autoignición: Temperatura mínima a la que una sustancia combustible debe calentarse en aire para
          iniciar una combustión autosostenida en ausencia de chispa, llama o fuente externa puntual de ignición.
\end{itemize}
...
Comprenden aquellos siniestros en los que intervienen materiales combustibles sólidos de origen orgánico o celulósico
(madera, papel, cartón, derivados textiles, gomas y ciertos polímeros termoestables). Su rasgo característico es que
mantienen una combustión en profundidad con formación de brasas incandescentes y residuos carbonosos o cenizas. El
mecanismo de extinción predominante y más eficaz consiste en el enfriamiento mediante agua o soluciones acuosas,
reduciendo la temperatura de la masa sólida por debajo de su punto de pirólisis.

\subsection{Fuegos Clase B}
Abarcan siniestros desarrollados en líquidos inflamables (naftas, alcoholes, solventes de pintura, éteres), líquidos
combustibles (gasoil, lubricantes automotrices, aceites térmicos minerales) y gases inflamables licuados o comprimidos
(propano, butano, metano, acetileno). En estos materiales no existe combustión profunda ni formación de brasas; el fuego
se concentra estrictamente en la interfase gaseosa superficial generada por los vapores en evaporación continua. Presentan
altas tasas de propagación y riesgos severos de reignición violenta. El método primordial de combate consiste en la
sofocación para privar al fuego de oxígeno (mediante espumas mecánicas o dióxido de carbono) o la interrupción química de
la reacción en cadena a través de polvos secos.
...
energizadas bajo tensión (transformadores, tableros de conmutación, centros de datos, motores y bandejas de cables). El
aspecto determinante en esta clase no es la naturaleza del combustible subyacente (que suele ser cobre, aislación de PVC,
aceite dieléctrico o polímeros), sino el riesgo letal de choque eléctrico hacia el operador si se utilizan agentes
conductores. Por ende, los agentes extintores autorizados deben ser dieléctricos certificados (dióxido de carbono, polvo
químico seco o agentes limpios). Cuando la instalación es desenergizada de forma visible mediante corte efectivo aguas
arriba, el fuego se reclasifica operativamente como Clase A o Clase B según el material que continúe ardiendo.

\subsection{Fuegos Clase D}
Son aquellos generados sobre metales químicamente activos y combustibles en polvo, virutas o piezas sólidas (magnesio,
sodio, potasio, titanio, circonio y litio). Desarrollan temperaturas de combustión extraordinariamente altas,
frecuentemente superiores a los $2000\Celsius$, y poseen una elevada avidez química por el oxígeno. La aplicación de agua
sobre un fuego Clase D genera una reacción violenta e instantánea de disociación molecular, liberando hidrógeno ($H_2$)
gaseoso que detona violentamente. El dióxido de carbono ($CO_2$) resulta igualmente ineficaz y peligroso, ya que estos
metales en ignición son capaces de reducir el dióxido de carbono formando carbono libre y óxidos metálicos. La única
forma técnica de extinción requiere polvos especiales a base de cloruro de sodio granulado o grafito con sales de cobre,
los cuales funden sobre el lecho metálico formando una capa impermeable que asfixia la reacción.
...
origen vegetal o animal (freidoras industriales, campanas de extracción y planchas gastronómicas). Estos lípidos operan a
temperaturas de servicio elevadas y poseen un calor específico alto junto con una baja conductividad térmica, lo que
dificulta enormemente su enfriamiento. Presentan temperaturas de autoignición entre $300\Celsius$ y $360\Celsius$. Si se
intenta extinguirlos mediante agua simple se provoca una violenta ebullición explosiva que proyecta
líquido ardiente en todas direcciones. La extinción requiere agentes extintores a base de soluciones de sales orgánicas
de potasio (químico húmedo), los cuales reaccionan con los ácidos grasos calientes mediante saponificación, formando una
capa jabonosa superficial densa que impide el contacto con el oxígeno mientras la fase acuosa enfría el aceite.
...
\section{El Fuego desde la Electrotecnia: Efecto Joule y Teoría de Contactos}
