...
El factor $f_o$ depende del destino edilicio. Determinado $N$, el número requerido de unidades de ancho de salida ($n$)
se calcula mediante la ecuación \ref{eq.cap4:uas}:
