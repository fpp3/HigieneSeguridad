...
Conforme a la norma IRAM 3517-1 en la República Argentina, los fuegos se
...
% Definición de la simbología geométrica y cromática normalizada (IRAM 3517-1)
...
\begin{table}[!ht]
    ...
    \end{tabular}
    \caption{Clasificación normalizada de fuegos conforme a la norma IRAM 3517-1.}
