...
\begin{itemize}
    ...
    \item Falla de Barreras Activas y Pasivas: Las pericias judiciales determinaron que el sistema de rociadores
          automáticos de extinción exigido reglamentariamente para depósitos de tal magnitud se encontraba inoperativo al
          momento del inicio del fuego: las válvulas sectoriales estaban cerradas o carecían de presión hídrica de servicio, y
          las bombas principales no arrancaron ante la demanda. Simultáneamente, la estructura portante de acero carecía de revestimientos ignífugos
...
\begin{itemize}
    ...
    \item Implicancias Tecnológicas: Este desastre constituye el ejemplo paradigmático de la vulnerabilidad de las
          ...
          fijos de inundación total con agentes limpios gaseosos (FK-5-1-12 o mezclas de gases inertes) y relés de detección
          de arco AFDD según norma IEC 62606.
\end{itemize}
